					...
					while($row = mysqli_fetch_array($result))
						{
							echo "<tr>";
								...
								echo "<td>"."</td>";
									...
									echo '<td><a href="admin_ViewEmployeeInfo.php?employee_id='.$row["product_id"].'" class="btn btn-primary">View</a></td>';
									
									echo '<td><a href="admin_EditEmployee.php?employee_id='.$row["product_id"].'" class="btn btn-success">Edit</a></td>';
								
									echo '<td><a href="admin_DeleteEmployee.php?employee_id='.$row["product_id"].'" class="btn btn-danger">Delete</a></td>';
