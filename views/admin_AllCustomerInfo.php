...
<div >
	...
	<h2 style="color:red" class="text" ><b><u> All Customers' Information of Sunadarban Courier Service : </u></b></h2>
		...
		function searchCustomer()
			{
				...
				http.open("GET","admin_Search_customer.php?sk="+search_word,true);
				http.send();
				...
				foreach($customer_information as $customer)
				{
					echo "<tr>";
						...
						echo "<td>"."</td>";
							...
							echo '<td><a href="admin_ViewCustomerInfo.php?customer_id='.$customer["customer_id"].'" class="btn btn-primary">View</a></td>';
							
							echo '<td><a href="admin_EditCustomer.php?customer_id='.$customer["customer_id"].'" class="btn btn-success">Edit</a></td>';
						
							echo '<td><a href="admin_DeleteCustomer.php?customer_id='.$customer["customer_id"].'" class="btn btn-danger">Delete</a></td>';
