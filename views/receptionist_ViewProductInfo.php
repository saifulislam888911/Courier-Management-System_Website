...
<div   class="center" >
		...
		<table>
			...
			<td align="center">
				...
				echo '<div class="add-to-cart"><span><a href="receptionist_EditEmployee.php?employee_id='.$employee["employee_id"].'" class="btn btn-success" style="width:185px;font-family:consolas;margin-top:5px;">Update Info</a></span></div>';
