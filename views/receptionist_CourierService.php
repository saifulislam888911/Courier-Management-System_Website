...
<div class="center">
	...
	<form method="post" action="../controllers/receptionist_ProductController.php" enctype="multipart/form-data" class="form-horizontal form-material">
...
<br/>
					...
					<div class="form-group text-center">
						...
						<input type="submit" class="btn btn-success" name="add_Product" value=" Add Order And Service " class="form-control">
