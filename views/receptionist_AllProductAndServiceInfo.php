<?php 
	...
	require '../controllers/receptionist_ProductController.php';
		...
		function searchProduct()
			{
				...
				http.open("GET","receptionist_Search_product.php?sk="+search_word,true);
				http.send();
				...
				foreach($product_information as $product)
				{
					echo "<tr>";
						...
						echo "<td>"."</td>";
							...
							echo '<td><a href="receptionist_ViewProductInfo.php?product_id='.$product["product_id"].'" class="btn btn-primary">View</a></td>';
							
							echo '<td><a href="receptionist_EditProduct.php?product_id='.$product["product_id"].'" class="btn btn-success">Edit</a></td>';
						
							echo '<td><a href="receptionist_DeleteProduct.php?employee_id='.$product["product_id"].'" class="btn btn-danger">Delete</a></td>';
