...
<div>
	...
	<table class="table table-striped">
		...
		//**************************************************************************************************	
									echo '<td><a href="admin_ViewCustomerInfo.php?customer_id='.$row["customer_id"].'" class="btn btn-primary">View</a></td>';
									
									echo '<td><a href="admin_EditCustomer.php?customer_id='.$row["customer_id"].'" class="btn btn-success">Edit</a></td>';
								
									echo '<td><a href="admin_DeleteCustomer.php?customer_id='.$row["customer_id"].'" class="btn btn-danger">Delete</a></td>';
